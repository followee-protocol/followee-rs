...
The Rust brief currently targets protocol repository commit `2d5292e95af022af7beee2d154e7217e29907960` (specification v0.8.1). When a normative ambiguity is resolved, the brief must be re-pinned and the complete conformance suite rerun.
