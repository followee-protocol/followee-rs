...
The Rust brief currently targets protocol repository commit `610f9a1e78d860e8bd685ef1435a53a16f1221ec` (specification v0.8). When a normative ambiguity is resolved, the brief must be re-pinned and the complete conformance suite rerun.
