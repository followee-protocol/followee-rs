...
The Rust brief currently targets protocol repository commit `abc9a55d90f1026e6509207abda73e5dc6d14241` (specification v0.7). When a normative ambiguity is resolved, the brief must be re-pinned and the complete conformance suite rerun.
